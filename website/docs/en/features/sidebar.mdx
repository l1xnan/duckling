...
- **Database explorer** — browse databases, schemas, tables, and columns of the connected source. Its search box filters as you type; the history button on the right opens recent searches (up to 8) to pick from. Press `Enter` to commit a search.
