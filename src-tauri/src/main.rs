  ...
  tauri::Builder::default()
    ...
    .plugin(
      tauri_plugin_log::Builder::new()
        ...
        .level_for("ssh2_config_rs", log::LevelFilter::Off)
    ...
    .invoke_handler(tauri::generate_handler![
      ...
      cmd::diagnostics::get_memory_snapshot,
      cmd::diagnostics::append_memory_log,
      cmd::diagnostics::read_memory_log_tail,
      cmd::diagnostics::clear_memory_log,
      cmd::diagnostics::open_diagnostics_dir,
      cmd::app::format_sql,
      ...
      cmd::app::get_scratch_dir,
      cmd::app::write_scratch_sql,
      cmd::app::read_scratch_sql,
      cmd::app::delete_scratch_sql,
      cmd::app::list_scratch_sql,
      cmd::app::open_path,
